package com.example.happylunch.config;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.
                ...
                // we permit the page below only for admin users
                        antMatchers("/statistics", "/restaurants/add").hasRole(RoleNameEnum.ADMIN.name()).
                //we permit the page below only for restaurant users
                        antMatchers("/menus/add", "/recipes/add").hasRole(RoleNameEnum.RESTAURANT.name()).
